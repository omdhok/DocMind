...
| Qualcomm QNN / Hexagon NPU execution (embedding stage) | Verified on real Snapdragon X Elite silicon via Qualcomm AI Hub device cloud compile+profile job — **[PASTE JOB URL HERE AFTER RUNNING]** | `qualcomm_ai_hub/profiling_reports/minilm_snapdragon_x_elite.json`, generated by `python scripts/aihub_profile.py` |
